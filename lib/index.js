...
__export(index_exports, {
  resolveFlyCLIBinaryPath: () => resolveFlyCLIBinaryPath,
...
function resolveFlyCLIBinaryPath() {
  ...
  const binPath = path4.resolve(__dirname, "..", "bin", binName);
  ...
  if (process.platform !== "win32") fs3.chmodSync(binPath, 493);
  return binPath;
}
