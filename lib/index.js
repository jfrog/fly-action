...
async function getIDToken2() {
  ...
  try {
    ...
    const wrapped = new Error(
      `Failed to get OIDC token: ${getErrorMessage(error2)}.
This almost always means the job is missing the 'id-token: write' permission, which is required for Fly to authenticate via GitHub OIDC.
